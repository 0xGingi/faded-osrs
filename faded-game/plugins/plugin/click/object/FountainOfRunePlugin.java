        ...
        for (Item item : player.inventory) {
            ...
            for (int glory : AMULET_OF_GLORY) {
                ...
                if (eternal) {
                    ...
                    World.sendMessage("<col=BA383E>Faded: <col=" + player.right.getColor() + ">" + player.getName() + " </col>has just found an <col=BA383E>amulet of eternal glory </col>from the <col=BA383E>fountain of rune</col>!");
                }
