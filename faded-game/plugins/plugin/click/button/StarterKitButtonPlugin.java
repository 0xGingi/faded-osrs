    ...
    private static void confirm(Player player) {
        if (player.buttonDelay.elapsed(1, TimeUnit.SECONDS)) {
          ...
          /*  if (kit.getRight() == PlayerRight.PLAYER) {
            ...
            player.message("<col=3559a5>Faded: </col>You will now be playing as " + Utility.getAOrAn(name) + " <col=3559a5>" + name + "</col> player.");
            player.message("<col=3559a5>Faded: </col>If you have any questions please visit our forums or contact a staff member.");
            ...
            ClanChannelHandler.connect(player, "faded");
