...
public enum TriviaBotData {
    _1("Who is the owner of Faded?", "0xGingi"),
    _2("Name one game developer.", "0xGingi", "gabe", "bepis", "penis"),
    ...
    _22("How many waves are there in the Fight Caves activity on Faded?", "15"),
