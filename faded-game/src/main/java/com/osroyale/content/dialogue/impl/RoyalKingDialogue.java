...
public class RoyalKingDialogue extends Dialogue {
    ...
    public void sendDialogues(DialogueFactory factory) {
        ...
        factory.sendOption("Claim Purchase", () -> claim(factory), "Donator Information", () -> player.send(new SendURL("https://github.com/0xGingi/faded-osrs/")), "My donation statistics", () -> myStats(factory), "Open Store", () -> store(factory), "Nevermind", factory::clear);
        factory.execute();
    }
