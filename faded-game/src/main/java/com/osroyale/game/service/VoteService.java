    ...
    public static void claimReward(Player player) {
        ...
        try (Connection connection = DriverManager.getConnection(CONNECTION_STRING, USER, PASS);
            ...
            if (!found) {
                ...
                World.sendMessage("<col=CF2192>Faded: <col=" + player.right.getColor() + ">" + player.getName() + " </col>has just voted! They have voted a total of <col=CF2192>" +  player.totalVotes + " </col>times.");
            }
