...
public final class Configuration {
    ...
    public static final String LIVE_GAME_ADDRESS = "184.58.95.217";
    public static final int LIVE_GAME_PORT = 43594;

    public static final String LIVE_CACHE_ADDRESS = "51.81.49.39";
     ...
     */
    public final static String NAME = "Faded";

    /**
     * The cache file name.
     */
    public final static String CACHE_NAME = ".faded";
