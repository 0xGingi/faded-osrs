    ...
    static NpcDefinition lookup(int npcId) {
        ...
        switch (npcId) {
            ...
            case 6773:
                ...
                break;
            case 7481:
                entityDef.name = "Faded Vote Agent";
                entityDef.actions = new String[5];
                entityDef.actions[0] = "Talk-to";
                entityDef.actions[2] = "Trade";
                break;
            ...
            case 1519:
                ...
                break;
            case 6533:
                entityDef.name = "Faded Skillermen";
                break;
            case 1520:
            ...
            case 6481:
                entityDef.name = "Mac";
                entityDef.description = "Only the most knowledgeable players of Faded are worthy of such a cape.".getBytes();
