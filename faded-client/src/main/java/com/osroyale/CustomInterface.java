...
//        personalStores(textDrawingAreas);
    ...
    private static void bankVault(TextDrawingArea[] tda) {
        ...
        addSprite(56301, 862);
        addText(56302, "Faded Bank Vault", tda, 2, 0xFFA500, true, true);
    ...
    private static void achievementInterface(TextDrawingArea[] tda) {
        ...
        addSprite(56801, 861);
        addText(56802, "Faded Achievements", tda, 2, 0xFFA500, true, true);
    ...
    private static void welcome(TextDrawingArea[] TDA) {
        ...
        addSprite(21300, 778);
        addHoverButton(21301, 298, 367, 45, "Enter Faded", -1, 21302, 1);
        ...
        addText(21311, "WELCOME TO FADED!", 0xE9EBC5, true, true, 52, TDA, 3);
        ...
        addText(21315, "Faded welcomes you!", 0x000000, true, false, 52, TDA, 0);
        addText(21316, "Faded welcomes you!", 0x000000, true, false, 52, TDA, 0);
        addText(21317, "Faded welcomes you!", 0x000000, true, false, 52, TDA, 0);
...
//            addDropdownMenu(26811, 136, 0, false, true, Dropdown.DEFAULT, "10", "100", "1,000", "10,000", "100,000");
  ...
  //          addDropdownMenu(26811, 150, -1, false, false, Dropdown.KEYBINDING, "None", "F1", "F2", "F3", "F4", "F5", "F6", "F7", "F8", "F9", "F10", "F11", "F12", "ESC");
    ...
    private static void starter(TextDrawingArea[] daniel) {
        ...
        addSprite(45001, 275);
        addText(45002, "Faded Account Setup", 0xff9933, true, true, 52, daniel, 2);
    ...
    private static void bank(TextDrawingArea[] tda) {
        ...
        addText(interfaceId + 5, "The Bank of Faded", tda, 2, 0xFF981F, true, true);
...
//        bank.child(60, interfaceId + 78, 19, 240);
    ...
    private static void informationTab(TextDrawingArea tda[]) {
        ...
        addHoverText(29404, "https://github.com/0xGingi/faded-osrs/", "Visit website", tda, 3, 0xC47423, true, true, 168);
    ...
    private static void toolPanel(TextDrawingArea tda[]) {
        ...
        addHoverText(35414, "https://github.com/0xGingi/faded-osrs/", "Visit website", tda, 3, 0xC47423, true, true, 168);
